...
export default function PresentationPage() {
  ...
  const slides = [
    {
      ...
      subtitle: 'Addressing competency gaps across civil service personnel using AI diagnostics.',
      icon: Target,
      bullets: [
        ...
        'SkillSaarthi AI introduces automated competency mapping aligned with iGOT Karmayogi national frameworks.',
        'Enables real-time readiness visibility for department heads and statistical ministry executives.',
      ],
      keyTakeaway: 'Goal: Reduce time-to-competency by 45% while achieving 98%+ diagnostic accuracy.',
    },
    {
      id: 2,
      tag: 'Slide 02',
      category: 'Core Architecture',
      title: 'Four Pillars of SkillSaarthi AI Platform',
      subtitle: 'An integrated intelligence ecosystem engineered specifically for public sector deployment.',
      icon: BrainCircuit,
      bullets: [
        ...
        'AI Quiz Generation Engine: Dynamically builds context-aware assessments directly from official manuals.',
    ...
    },
    {
      ...
      bullets: [
        ...
        '2. AI Diagnostic Scan — Automated evaluation identifying strengths and specific target skill gaps.',
        ...
        '5. Verification & Certification — Context-aware AI evaluation updates the officer’s official registry profile.',
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        'Phase 2 (Current): Full iGOT Karmayogi single sign-on & automated AI quiz generation from PDF manuals.',
        'Phase 3 (Q3 2026): Multilingual voice assistant for field survey personnel in 12 Indian regional languages.',
        'Phase 4 (Q4 2026): Predictive departmental staffing gap modeling for upcoming national censuses.',
      ],
      keyTakeaway: 'Establishing a benchmark for AI-driven public sector talent development globally.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-[#111827] font-sans antialiased selection:bg-[#2563EB]/15 selection:text-[#2563EB]">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <div className="flex items-center space-x-2">
              <span className="font-bold text-slate-900 tracking-tight text-base">
                SkillSaarthi <span className="text-[#2563EB]">AI</span>
              </span>
              <span className="text-xs text-slate-400 font-mono">/ Deck View</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-lg bg-[#2563EB] text-white text-xs font-semibold hover:bg-blue-700 transition-colors shadow-xs"
            >
              Web Landing Page
            </button>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Left Sidebar: Slide Index / Navigation (Notion / Linear Style) */}
        <aside className="lg:col-span-4 space-y-3">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3.5 rounded-xl transition-all duration-200 flex items-start space-x-3 group relative ${
                    isActive
                      ? 'bg-white shadow-[0_4px_20px_-2px_rgba(17,24,39,0.06)] border-l-4 border-[#2563EB] text-[#111827]'
                      : 'hover:bg-slate-200/50 text-slate-600 hover:text-slate-900'
                  }`}
                >
                  <div
                    className={`p-2 rounded-lg mt-0.5 shrink-0 transition-colors ${
                      isActive ? 'bg-blue-50 text-[#2563EB]' : 'bg-slate-100 text-slate-500 group-hover:bg-slate-200/80'
                    }`}
                  >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className={`text-sm font-semibold truncate ${isActive ? 'text-[#111827]' : 'text-slate-700'}`}>
                      {s.title}
                    </div>
          ...
          <div className="pt-6 border-t border-slate-200/80 flex items-center justify-between px-2">
            ...
            <button
              ...
              className="p-2.5 rounded-lg bg-[#2563EB] text-white disabled:opacity-40 disabled:cursor-not-allowed hover:bg-blue-700 shadow-xs transition-colors flex items-center space-x-1.5 text-xs font-semibold"
            >
        ...
        {/* Right Area: Main Active Slide Canvas (Clean Notion/Stripe/Linear Card) */}
        <section className="lg:col-span-8">
          <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-[0_4px_24px_-2px_rgba(17,24,39,0.06)] border border-slate-100 space-y-8 relative overflow-hidden transition-all duration-300">
            
            {/* Slide Header */}
            <div className="space-y-3 pb-6 border-b border-slate-100">
              <div className="flex items-center justify-between">
                <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-50 text-[#2563EB] text-xs font-semibold">
            ...
            {/* Bullet Points Container (Clean bullet structure) */}
            <div className="space-y-4">
              ...
              <ul className="space-y-3.5">
                {activeSlideData.bullets.map((bullet, idx) => (
                  <li
                    key={idx}
                    className="flex items-start space-x-3.5 p-3 rounded-xl hover:bg-slate-50 transition-colors group"
                  >
                    <div className="w-5 h-5 rounded-full bg-blue-50 text-[#2563EB] flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#2563EB] group-hover:text-white transition-colors">
            ...
            <div className="p-4.5 rounded-xl bg-slate-50 border-l-4 border-[#2563EB] text-[#111827] space-y-1">
              <div className="text-xs font-bold uppercase tracking-wider text-[#2563EB] flex items-center space-x-1.5">
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
              <span className="font-mono">SkillSaarthi AI — Government Edition</span>

              <div className="flex items-center space-x-3">
                <button
                  onClick={() => setCurrentSlide((prev) => Math.max(0, prev - 1))}
                  disabled={currentSlide === 0}
                  className="hover:text-[#2563EB] disabled:opacity-30 disabled:hover:text-slate-500 font-semibold flex items-center space-x-1"
                >
                  <ChevronLeft className="w-4 h-4" />
                  <span>Prev</span>
                </button>
                ...
                <button
                  onClick={() => setCurrentSlide((prev) => Math.min(slides.length - 1, prev + 1))}
                  disabled={currentSlide === slides.length - 1}
                  className="hover:text-[#2563EB] disabled:opacity-30 disabled:hover:text-slate-500 font-semibold flex items-center space-x-1 text-[#2563EB]"
                >
                  <span>Next</span>
                  <ChevronRight className="w-4 h-4" />
                </button>
