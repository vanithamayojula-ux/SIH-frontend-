...
function Employees() {
  ...
  const navigateFromEmployee = (_employee: Employee, page: string) => {
    const routeMap: Record<string, string> = {
      'Skill Gap Distribution': '/admin/skill-gap-distribution',
      'Training Demand': '/admin/training-demand',
      'Course Utilization': '/admin/course-utilization',
      ...
      <section className="data-section employee-directory-section">
        ...
        <p className="plain-insight employee-insight">
          {filteredEmployees.length === 0
            ...
            : `${filteredEmployees[0].department} employees have the highest score in this filtered view.`}
        </p>
      </section>
